      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <!-- withdraw list menu -->
                                <li class="nav-item menu-open navr-3">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card mt-5">
                                        <div class="card-body">
                                		    <!--withdraw section-->
                                             <form role="form" action="https://aidigitalassets.global/Main-Wallet-Request" id="submit-form" method="post" enctype="multipart/form-data" style="margin-top: -40px;">
                                             <input type="hidden" name="_token" value="YuZXixLaqSB2ZCasoNLJsSaFRxpCQAPf7ZMYUhtq">
                                                      <center>
                                                          <br>
                                                            <p id="error1" style="color: red;font-weight: bold;"></p>
                                                      </center>
                                                      <br>
                                                        <!--withdraw type-->
                                                        <input type="hidden" name="withdraw_type" value="crypto" />
                                                        <!--username-->
                                                        <input type="hidden" class="form-control" name="username" value="admin" placeholder="Username" readonly="" required="">
                                                        <!--wallet type-->
                                                        <!-- <div class="form-group col-md-12 mb-3">-->
                                                        <!--    <label class="col-form-label">Main Wallet <span id="balancetxt" ></span></label>-->
                                                        <!--    <select class="custom-select" name="wallet" id="wallet" required="required" onchange="getbalance(this.value)" >-->
                                                                <!--<option value="" >---Select---</option>-->
                                                        <!--                 <option value="totalwallet" selected>300.0000</option>-->
                                                                
                                                        <!--    </select>-->
                                                        <!--</div>-->
                                                        
                                                        <input type="hidden" class="form-control" name="wallet" id="wallet" value="totalwallet" placeholder="Username" readonly="" required="">
                                                        
                                                        <div class="form-group col-md-12 mb-3">
                                                            <label class="col-form-label">Main Wallet <span id="balancetxt" ></span></label>
                                                            <input type="text" class="form-control" placeholder="300.0000" readonly="" >
                                                        </div>
                                                        
                                                        <!--balance-->
                                                        <input type="hidden" class="form-control" name="balance" value="300.0000" id="balance" placeholder="0.00" readonly="" required="">
                                                        <!--crpto type-->
                                                        <!--<div class="form-group col-md-12 mb-3">-->
                                                        <!--    <label class="col-form-label">Select Crypto</label>-->
                                                        <!--    <select class="custom-select" name="paygateway" required="required" onchange="getnumber(this.value)" >-->
                                                        <!--        <option value="">---Select---</option>-->
                                                        <!--        <option value="BUSD.BEP20">BUSD ( BUSD.BEP20 )</option>-->
                                                                
                                                        <!--    </select>-->
                                                        <!--</div>-->
                                                        <input type="hidden" class="form-control" name="paygateway" value="USDT.BEP20" required="">
                                                        <!--gateway details-->
                                                        <input type="hidden" class="form-control" name="gatewaydetail" value="TS8qUJtP6WXBhttt5yp7XLk5dx4BcqAe2z" id="paymentgateway" required="">
                                                        <!--balance-->
                                                        
                                                        <!--crpto type-->
                                                        <div class="form-group col-md-12 mb-3">
                                                            <label class="col-form-label">Enter Amount In  USDT </label>
                                                            <input type="number" class="form-control" name="amount" onchange="checkamountwallet(this.value)" placeholder="Enter amount" required="" pattern="\d*">
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 mb-3">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" maxlength="6" style="float:left; width: 70%;" class="form-control" id="validationCustomUsername" name="otp"   placeholder="please enter OTP" aria-describedby="inputGroupPrepend" required="">
                                                                <button class="btn btn-danger" id="otp" type="button" onclick="otpsend()" style="float:left; width: 30%;">send otp</button>
                                                            </div>
                                                        </div>
                                                    
                                                                                                                                                                              <center>    
                                                                <button class="btn btn-primary" id="btn-submit" type="submit">Withdraw</button>
                                                            </center>
                                                                                                                                                                          <br>
                                                    </form>
                                		    <!--withdraw section-->
...
function otpsend(){
    ...
    var BASE_URL = "https://aidigitalassets.global";
...
function getbalance(wallettype){
    ...
    var total_wallet     = 300.0000;
    $('#btn-submit').attr("disabled",false);
    document.getElementById('balancetxt').innerHTML = "";
    
    if (wallettype == 'totalwallet') {
        document.getElementById('balance').value = total_wallet;
        var withdrawable = Math.min(1000, total_wallet);
        document.getElementById('balancetxt').innerHTML = "( withdrawable = "+withdrawable+" )";
        if(total_wallet < 10){
            var balmsg = "Your Wallet Balance Is Less Than Minimum Wallet Balance Amount Minimum Amount Required Balance Is "+10;
...
function getnumber(currency) {
    ...
    var trxaddress  = "";
    var usdtaddress  = "";
    var busdaddress  = "TS8qUJtP6WXBhttt5yp7XLk5dx4BcqAe2z";
    
    
    if (currency == 'BTC') {
        document.getElementById('paymentgateway').value = btcaddress;
    } else if (currency == 'ETH'){
        document.getElementById('paymentgateway').value = ethaddress;
    }  else if (currency == 'TRX'){
        document.getElementById('paymentgateway').value = trxaddress;
    }  else if (currency == 'USDT.TRC20'){
        document.getElementById('paymentgateway').value = usdtaddress;
    }  else if (currency == 'BUSD.BEP20'){
        document.getElementById('paymentgateway').value = busdaddress;
    }else{
...
function checkamountwallet(amt){
    
    var amt = amt;
    var walletsel = document.getElementById('wallet').value;

    $('#error1').html('');

    if(walletsel != ''){

        if (walletsel == 'totalwallet') {
            if(amt >= 10){
                if(300.0000 >= amt ){
                     $('#error1').html('');
                     $('#btn-submit').attr("disabled",false);
                     ...
                     $('#btn-submit').attr("disabled",true);   
                     toastr.error("Your main wallet balance dont have sufficent amount to withdraw,");
                }   
                
            }else{
                $('#btn-submit').attr("disabled",true);   
                toastr.error("minimum Withdraw Amount is "+10+" And There Is No Maximum Withdraw Amount Limit ");
            }
             

        }else{
            toastr.error("Invalid Wallet Select!");
        }

    }else{
        toastr.error("Please Select Wallet First!");
    }
