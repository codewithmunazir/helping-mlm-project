          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <!-- deposite list menu -->
                        ...
                        <li  class="nav-item">
                          ...
                          <li  class="nav-item">
                                                        <a href="https://aidigitalassets.global/Deposite-History" class="nav-link active">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Request History</p>
                            </a>
                          </li>
                                               ...
                                               <!-- fund history -->
                                                        ...
                                                        <table class="table text-center">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <td>USDT.TRC20</td>
                                                                <td>100.00</td>
                                                                <!--<td>100.00000 USDT.TRC20</td>-->
                                                                <td>OD54378</td>
                                                                <td></td>
                                                                <td>2024-12-11 02:39 pm</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD54378" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        <tr>
                                                                <td>2</td>
                                                                <td>USDT.TRC20</td>
                                                                <td>25.00</td>
                                                                <!--<td>25.00000 USDT.TRC20</td>-->
                                                                <td>OD94664</td>
                                                                <td></td>
                                                                <td>2024-12-06 09:45 am</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD94664" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        <tr>
                                                                <td>3</td>
                                                                <td>USDT.TRC20</td>
                                                                <td>500.00</td>
                                                                <!--<td>500.00000 USDT.TRC20</td>-->
                                                                <td>OD39153</td>
                                                                <td></td>
                                                                <td>2024-11-28 01:14 pm</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD39153" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        <tr>
                                                                <td>4</td>
                                                                <td>USDT.TRC20</td>
                                                                <td>50.00</td>
                                                                <!--<td>50.00000 USDT.TRC20</td>-->
                                                                <td>OD40929</td>
                                                                <td></td>
                                                                <td>2024-11-27 09:58 pm</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD40929" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        <tr>
                                                                <td>5</td>
                                                                ...
                                                                <td>OD24971</td>
                                                                <td></td>
                                                                <td>2024-10-25 09:36 pm</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD24971" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        <tr>
                                                                <td>6</td>
                                                                ...
                                                                <td>OD31668</td>
                                                                <td></td>
                                                                <td>2024-10-21 12:08 am</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD31668" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        <tr>
                                                                <td>7</td>
                                                                ...
                                                                <td>OD62497</td>
                                                                <td></td>
                                                                <td>2024-10-19 06:02 pm</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD62497" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        <tr>
                                                                <td>8</td>
                                                                ...
                                                                <td>OD11285</td>
                                                                <td></td>
                                                                <td>2024-10-18 10:06 pm</td>
                                                                <td>
                                                                                                                                        Waiting
                                                                                                                                    </td>
                                                                <td>
                                                                                                                                        <a href="https://aidigitalassets.global/Deposite-status/OD11285" style="background: red; padding: 2px 15px 2px 15px;  color: white; font-size: 13px; font-weight: bold;">View</a>
                                                                                                                                    </td>
                                                            </tr>
                                                                                                                        </tbody>
                                                        </table>
