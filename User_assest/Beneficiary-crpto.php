          ...
          <!-- Add icons to the links using the .nav-icon class
            ...
            <!-- withdraw list menu -->
                        ...
                        <p>
                          ...
                          <li  class="nav-item">
                                                        <a href="https://aidigitalassets.global/Beneficiary-crpto" class="nav-link active">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Beneficiary</p>
                            </a>
                          </li>
                 ...
                 <!-- Content Header (Page header) -->
                  <div class="content-header">
                    <div class="container-fluid">
                      <div class="row mb-2">
                        <div class="col-sm-6">
                          <h1 class="m-0 text-dark">Beneficiary Section</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                          <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="https://aidigitalassets.global">Home</a></li>
                            <li class="breadcrumb-item active">Beneficiary Section</li>
                          </ol>
                        </div><!-- /.col -->
                      </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                    ...
                    <section class="content">
                      <div class="container-fluid" style="margin-top: -35px;">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                                                                <form role="form" action="https://aidigitalassets.global/Add-Beneficiary-crpto" method="post" >
                                         <input type="hidden" name="_token" value="YuZXixLaqSB2ZCasoNLJsSaFRxpCQAPf7ZMYUhtq">
                                            <div class="form-row">
                                                <center>
                                                    <p style="text-align: center; font-weight:bold;">Add New Beneficiary</p>
                                                </center>
                                                <br>
                                               ...
                                               <p id='msg1' style=" font-size: 14px; width: 100%; font-weight: bold;"></p>
                                                ...
                                                <!--    <label for="validationCustom01">TRX Address</label>-->
                                                <!--    <input type="text" class="form-control" name="trxaddress" placeholder="TRX Address..." value="" required="">-->
                                                <!--</div>-->
                                                
                                                 <div class="col-md-12 mb-3" >
                                                    <label for="validationCustom01">USDT ( USDT.TRC20 ) Address</label>
                                                    <input type="text" class="form-control" name="busdaddress" placeholder="USDT ( USDT.TRC20 ) Address..." value="TS8qUJtP6WXBhttt5yp7XLk5dx4BcqAe2z" required="">
                                                </div>
                                        ...
                                        <hr>
                                        <label class="col-form-label">Beneficiary</label>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table text-center">
                                                    ...
                                                    <tr>
                                                        <td>admin ( admin ) </td>
                                                        <!--<td></td>-->
                                                        <td>TS8qUJtP6WXBhttt5yp7XLk5dx4BcqAe2z</td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
...
<script src="https://aidigitalassets.global/public/panel/assets/js/jquery-3.3.1.js"></script>
