...
<aside class="main-sidebar elevation-4 sidebar-light-info" style="background: #000f15; min-height: 1400px;">
      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <!-- active -->
            <li class="nav-item">
                              <a href="https://aidigitalassets.global/Top-Up-User" class="nav-link active">
            ...
            <!-- deposite list menu -->
                        ...
                        <li  class="nav-item">
                                                        <a href="https://aidigitalassets.global/Deposite" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Send Request</p>
                            </a>
                          </li>
   ...
   .nav-pills .nav-link.active, .nav-pills .show>.nav-link{
      background-color: #0f5aab !important;
   }
   .colortext{
      color: green;
   }
 ...
 --transition-fast: 0.1s;
   ...
   input[type="radio"] {
    ...
    .total_btn:not(:disabled):not(.disabled) {
        cursor: pointer;
    }
    .total_btn:hover {
        -webkit-box-shadow: 0px 0px 10px 0px rgb(255 9 9);
        box-shadow: 0px 0px 10px 0px rgb(255 9 9);
    }
                 ...
                 <!-- Content Header (Page header) -->
                  <div class="content-header">
                    <div class="container-fluid">
                      <div class="row mb-2">
                        <div class="col-sm-6">
                          <h1 class="m-0 text-dark">Active ID</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                          <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="https://aidigitalassets.global">Home</a></li>
                            <li class="breadcrumb-item active">Active ID</li>
                          </ol>
                        </div><!-- /.col -->
                      </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                    ...
                    <section class="content">
                      <div class="container-fluid" style="margin-top: -35px;">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <form role="form" action="https://aidigitalassets.global/Active-User-Processing" method="post" >
                                         <input type="hidden" name="_token" value="YuZXixLaqSB2ZCasoNLJsSaFRxpCQAPf7ZMYUhtq">
                                            <div class="form-row">
                                                <center>
                                                    <p style="text-align: center;">Available Balance :  USDT  0.00</p>
                                                </center>
                                                <br>

                                               <div style="clear: both;"></div>
                                               <!--<input type="hidden" name="package" id="package" />-->
                                               <p id='msg1' style=" font-size: 14px; width: 100%; font-weight: bold;"></p>
                                                
                                               <div style="clear: both;"></div>
                                               
                                                <div class="col-md-12 mb-0">
                                                    <label for="validationCustom02">Enter Amount</label>
                                                    <input type="text" class="form-control" name="package" id="package" value="0" onchange="checkuserbalance(this.value)" placeholder="Enter Amount" style="color: wheat;" required="">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="button-quantity" onclick="increaseINR(50)" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #74ff16;width: 160px;float: left;margin-top: 15px;" >+50 USDT</button>
                                                    
                                                    <button type="button" class="button-quantity" onclick="increaseINR(100)" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #74ff16;width: 160px;float: left;margin-top: 15px;" >+100 USDT</button>
                                                    
                                                    <button type="button" class="button-quantity" onclick="increaseINR(500)" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #74ff16;width: 160px;float: left;margin-top: 15px;" >+500 USDT</button>
                                                    
                                                    <button type="button" class="button-quantity" onclick="increaseINR(1000)" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #74ff16;width: 160px;float: left;margin-top: 15px;" >+1000 USDT</button>
                                                    
                                                    <button type="button" class="button-quantity" onclick="increaseINR(5000)" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #74ff16;width: 160px;float: left;margin-top: 15px;" >+5000 USDT</button>
                                                    
                                                    <button type="button" class="button-quantity" onclick="increaseINR(10000)" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #74ff16;width: 160px;float: left;margin-top: 15px;" >+10000 USDT</button>
                                                    
                                                    <button type="button" class="button-quantity" onclick="increaseINR(20000)" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #74ff16;width: 160px;float: left;margin-top: 15px;" >+20000 USDT</button>
                                                    
                                                    <button type="button" class="button-quantity" onclick="resetINR()" style="background: linear-gradient(246.62deg, #ff18c0 -10.93%, #5daeef 7.34%, #94ef5b 89.85%, #5fe9e6 106.94%) !important;color: black;border: 2px solid #827984;width: 160px;float: left;margin-top: 15px;color: black;font-weight: 500;" >Reset Amount</button>
                                                ...
                                                <div class="col-md-12 mb-3" >
                                                    ...
                                                    <input type="hidden" name="payextra" id="payextrafield" required="">
                                                    
                                                   <hr>
                                                    <label for="validationCustom01">Username</label>
                                                    <input type="text" class="form-control" name="username" placeholder="User name" value="" onChange="getreferal(this.value)" required="">
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="referred2" name="fullname" value="" placeholder="Full name" readonly="" required="">
                                                    <div class="valid-feedback">
                                                        Looks good!
                                                    </div>
                                                </div>
                                            ...
                                            <center>
                                                <input type="submit" class="btn btn-primary" id="btnSubmit"  value="Process Request" />
                                            </center>
                                            
                                        </form>
                                        <hr>
                                        <label class="col-form-label">ID Activation History</label>
...
<script src="https://aidigitalassets.global/public/panel/dist/js/jquery-3.3.1.js"></script>
...
<script>
    ...
    function increaseINR(amount) {
        var currentAmount = parseInt($('#package').val()) || 0;  // Get the current value of the package input or 0 if empty
        var newAmount = currentAmount + parseInt(amount);  // Add the amount to the current value
        
        // Optional: Add a maximum limit for the amount
        // if (newAmount > 20000) {
        //     newAmount = 20000;  // Set the maximum limit
        // }
        
        $('#package').val(newAmount);  // Set the new amount in the input field
    }

    function resetINR() {
    //   $('#payextrafield').val(0);
    //   $('#totalSelectedINR').html(0);
      $('#package').val(0);
    }
</script>
...
<script>
    ...
    function payextrachange() {
      var percent = parseInt($('#totalSelectedINR').html()) * 10 / 100;
      var amount = parseInt($('#totalSelectedINR').html()) + parseInt(percent);
      var checkextra = $('#payextrafield').val();
      ...
      if(checkextra == 0){
          ...
          if(amount > 22000){
              $('#payextrafield').val(1);
              $('#package').val(22000);
              $('#totalSelectedINR').html(22000);
          }else{
              $('#payextrafield').val(1);
              $('#package').val(amount);
              $('#totalSelectedINR').html(amount);
          }
...
<script type="text/javascript">
    function checkuserbalance(amount){
        ...
        if (amount <= bal) {
            ...
            document.getElementById("msg1").style.color = "#38ff35";
            document.getElementById("msg1").innerHTML = "";
        } else {
            document.getElementById("btnSubmit").disabled = true;
            document.getElementById("msg1").style.color = "#ff6464";
            document.getElementById("msg1").innerHTML = "Insufficent Balance!";
        }
    }
</script>
...
function getreferal(name){
    
    document.getElementById("load").style.display = "block";
    
    var referalusername = name;
    
    var dataString = 'referalusername='+ referalusername;
    
    BASE_URL  = 'https://aidigitalassets.global';
          $.ajax({
            url:BASE_URL+'/user-name-get-active?'+dataString,
            type:'GET',
            success: function(data) {
                $("#referred2").val(data.name);
                if (data.msg === 'invalid') {
                    $('#btnSubmit').attr("disabled",true);
                    $('#btnSubmit').val('Invalid User');
                } else {
                    console.log(data.status);
                    // if (data.status == 1) {
                    //     $('#btnSubmit').attr("disabled",true);	
                    //     $('#btnSubmit').val('This User Is Already Active');	
                    // } else {
                        $('#btnSubmit').attr("disabled",false);
                        $('#btnSubmit').val('Process Request');
                    // }
                }
    ...
    function insufficientbalance() {
        alert("You have insufficient balance in your Deposite account please contact your admin to update Your wallet");
    }
