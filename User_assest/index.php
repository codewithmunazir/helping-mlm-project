      ...
      <nav class="mt-2" >
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <!-- dashboard -->
            <li class="nav-item">
                                <a href="https://aidigitalassets.global/User-Dashboard" class="nav-link active">
...
<gecko-coin-price-marquee-widget locale="en" outlined="true" coin-ids="" dark-mode="true" initial-currency="usd"></gecko-coin-price-marquee-widget>
                      ...
                      <br>
                          ...
                          <div class="progress-group">
                              <span class="progress-text" style="color: white;">My Bonus Limit</span>
                              <span class="float-right" style="color: white;"><b>300.00</b>/300.00</span>
                    ...
                    <br>  
                    <div class="row">
                    <div href="#" class="ae" style="width:100%;padding-top: 14px;padding-bottom: 0px;">
<div class="iconw" style="display:flex;margin-bottom: 10px;width:100%;line-height:30px">
<div style="text-align: center;  width: 100%;">
<h5 class="tltlea  gColor" style="width: 100%">
Referral Income
</h5>
<span class="text-muted" id="incomeaa2b">$ </span>
<div class="col-md-12" style="display:flex;padding: 0px;">
<div class="col-md-12" style="width:100%;text-align: center;margin-top: -7px;">
<button onclick="window.location.href='directearning.php'" class="btn btn-primary btn-anim" id="btnCopyToClibord1" style="margin-top: 15px;   background: #001516;   border: 0px;   box-shadow: 0 0 4px 0 #02fff3; "><span class="btn-text" style="color:#fff">Income</span></button>
</div>
                    ...
                    <div class="col-lg-12 col-sm-12 mt-4 mb-2">
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        <div style="width: 40%; float: left;">
                                                            <center>
                                                            <img src="https://aidigitalassets.global/public/man.png" style="height: 65px; object-fit: contain;" />
                                                            </center>
                                                        </div>
                                                        
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Available Fund</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000; margin-top: -20px;">0.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        <div style="width: 40%; float: left;">
                                                            <center>
                                                            <img src="https://aidigitalassets.global/public/purse-1.png" style="height: 65px; object-fit: contain;" />
                                                            </center>
                                                        </div>
                                                        
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Main Balance</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">300.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        <div style="width: 40%; float: left;">
                                                            <center>
                                                            <img src="https://aidigitalassets.global/public/salary.png" style="height: 65px; object-fit: contain;" />
                                                            </center>
                                                        </div>
                                                        
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Cashback Bonus</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">0.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Affiliate Bonus</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">300.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Level Affiliate</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">0.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Booster Bonus</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">0.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Monthly Bonus</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">0.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Total Income</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">300.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        <div style="width: 40%; float: left;">
                                                            <center>
                                                            <img src="https://aidigitalassets.global/public/package.png" style="height: 65px; object-fit: contain;" />
                                                            </center>
                                                        </div>
                                                        
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">My Investment</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">100.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        <div style="width: 40%; float: left;">
                                                            <center>
                                                            <img src="https://aidigitalassets.global/public/withdrawal-1.png" style="height: 65px; object-fit: contain;" />
                                                            </center>
                                                        </div>
                                                        
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Pending Withdraw</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">0.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Completed Withdraw</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">0.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        <div style="width: 40%; float: left;">
                                                            <center>
                                                            <img src="https://aidigitalassets.global/public/developers.png" style="height: 65px; object-fit: contain;" />
                                                            </center>
                                                        </div>
                                                        
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Total Direct</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">3</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Active Direct</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">1</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card shadow">
                                                <div class="padding-4" style="padding: 35px 10px 30px 10px;">
                                                    <div class="row">
                                                        ...
                                                        <div style="width: 60%; float: left;">
                                                                <!--<p style="font-size: 3rem!important; font-weight: bold; color: #3b82f6;">300.00 $</p>-->
                                                                <p style="font-size: 18px !important; font-weight: bold; color: #000c49;margin-top: 5px;">Total Team Volume</p>
                                                                <p style="font-size: 19px !important;font-weight: bold;color: #000;margin-top: -20px;">30550.00 $</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-footer bg-white p-0" style="border-radius: 25px;background: #0f1018 !important;">
                                      <ul class="nav nav-pills flex-column">
                                        <li class="nav-item">
                                          ...
                                          <!-- new info div -->
                                          <p id="p1" style="display: none;">https://aidigitalassets.global/Register/admin</p>
                                        </li>
                                      </ul>
                                    </div>
                                    <!-- /.footer -->
                            ...
                            <br>
                              ...
                              <div class="col-12"style="margin-top: 15px;">
                                    <iframe src="https://fxpricing.com/fx-widget/forex-cross-rates.php?symbol=EUR,USD,CHF,JPY,GBP,NZD,AED,INR&click_target=blank&theme=dark&tm-cr=212529&hr-cr=FFFFFF13&flags=circle&font=Arial, sans-serif" width="100%" height="370" style="border: 1px solid #eee;"></iframe><div id="fx-pricing-widget-copyright"><span>Powered by </span><a href="https://fxpricing.com/" target="_blank">FX Pricing</a></div><style type="text/css">#fx-pricing-widget-copyright{text-align: center; font-size: 13px; font-family: sans-serif; margin-top: 10px; margin-bottom: 10px; color: #9db2bd;} #fx-pricing-widget-copyright a{text-decoration: unset; color: #bb3534; font-weight: 600;}</style>
                              </div>
...
<script>
  function baseurl(){
      var url = "https://aidigitalassets.global";
      return url;
  }
</script>
