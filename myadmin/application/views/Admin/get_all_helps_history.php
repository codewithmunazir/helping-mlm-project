    ...
    <button id="filter">Filter</button>
          ...
          <thead>
                  <tr>
                     ...
                     <th scope="col">Help Amount</th>
                     <th scope="col">Get Amount</th>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            function load_data(user_id = '', page = 1) {
                $.ajax({
                    url: base_Url+'Admin/fetch_data_coomit_widthdral',
                    type: "POST",
                        ...
                        if (data.records.length > 0) {
                            $.each(data.records, function(index, record) {
                             var balance = record.get_amount - record.get_amout;
                              // if(record.wstatus=='A12B13')
                              // {
                              //   var  stts="Received From Admin";
                              // }else{
                              //   var stts=record.wstatus;
                              ...
                              // }
                                ...
                                var row = '<tr>' +
                                    ...
                                    '<td>$' + (record.request_amt - record.get_amout) + '</td>' +
