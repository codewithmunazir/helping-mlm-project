        ...
        <div class="col-lg-6 m-auto">
            <div class="card">
              ...
              <?php } ?>
                    ...
                    <form action="<?php echo base_url();?>create_news" method="POST">
                        
                        <div class="form-froup">
                            <label for="msg">Insert Message</label> <?php echo form_error('news_crete'); ?>
                            
                                            <textarea class="form-control" placeholder="Write information here....." style="height:150px;" name="news_crete"></textarea>
