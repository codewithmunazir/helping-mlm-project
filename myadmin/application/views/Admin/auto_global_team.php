  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Transfer Fund To User</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="col-lg-6 m-auto">
            <div class="card">
                <div class="crad-header bg-info text-center"><h4 class="mb-3"> Fund Transfer TO User</h4>
              ...
              <?php } ?>
                    ...
                    <form action="<?php echo base_url();?>auto_global_team" method="POST">
                        ...
                        <div class="form-froup">
                            <label for="userid">Increse User</label>
                            <?php echo form_input(['class'=>'form-control','type'=>'text', 'name'=>'user_increase','placeholder'=>'Enter User','id'=>'userid', 'value'=>set_value('user_increase')]);?>
                            
                            <?php echo form_error('user_increase'); ?>
                        </div>
