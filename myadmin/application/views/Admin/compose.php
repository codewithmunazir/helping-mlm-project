        ...
        <div class="col-lg-6 m-auto">
            <div class="card">
              ...
              <?php } ?>
                    ...
                    <form action="<?php echo base_url();?>compose" method="POST">
                      <div class="form-froup">
                        ...
                        <div class="form-froup">
                            ...
                            <?php echo form_input(['class'=>'form-control','type'=>'text', 'name'=>'subject','placeholder'=>'Enter Amount','id'=>'subject', 'value'=>set_value('subject')]);?>
                            
                            <?php echo form_error('subject'); ?>
                        </div>
                        <div class="form-froup">
  
                            <label for="text_area" >Message</label><?php echo form_error('message'); ?>
                                            <textarea id="text_area" class="form-control" placeholder="Write Message Here....." style="height:150px;" name="message"></textarea>
