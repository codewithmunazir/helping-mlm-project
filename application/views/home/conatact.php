<?php include('header.php');?>
			...
			<main class="main">
				<section class="promo-primary">
					<picture>
						<source srcset="<?php echo base_url();?>Assest/img/contacts.jpg" media="(min-width: 992px)"><img class="img--bg" src="<?php echo base_url();?>Assest/img/contacts.jpg" alt="img">
					</picture>
						...
						<div class="row">
							<div class="col-auto">
								<div class="align-container">
									<div class="align-container__item"><span class="promo-primary__pre-title">DOUBLE POWER</span>
					...
					<div class="container">
						<div class="row offset-margin">
							<div class="col-sm-6 col-lg-3">
								<div class="icon-item">
									<div class="icon-item__img"><img class="img--layout" src="<?php echo base_url();?>Assest/img/icon_1-1.png" alt="img">
							...
							<div class="col-sm-6 col-lg-3">
								<div class="icon-item">
									<div class="icon-item__img"><img class="img--layout" src="<?php echo base_url();?>Assest/img/icon_2-2.png" alt="img">
							...
							<div class="col-sm-6 col-lg-3">
								<div class="icon-item">
									<div class="icon-item__img"><img class="img--layout" src="<?php echo base_url();?>Assest/img/icon_3-3.png" alt="img">
										<svg class="icon icon-item__icon icon--green">
											<use xlink:href="#envelope"></use>
										</svg>
									</div>
									<div class="icon-item__text">
										<p>Email: <a class="icon-item__link" href="mailto:support@helpo.org">support@doublepower33days.com</a></p>
									</div>
								</div>
							</div>
							<div class="col-sm-6 col-lg-3">
								<div class="icon-item">
									<div class="icon-item__img"><img class="img--layout" src="<?php echo base_url();?>Assest/img/icon_4-4.png" alt="img">
					...
					<div class="contacts-wrapper">
						<div class="container">
							<div class="row justify-content-end">
								<div class="col-xl-6">
									<form class="form message-form" action="<?php echo base_url();?>contact-us" Method="POST">
									...
									<span class="text-success" id="hide_data"><?php echo $form_sumit;?></span>
								</div>
							</div>
						</div>
				...
				<section class="bottom-background">
					<div class="container">
						<div class="row">
							<div class="col-12">
								<div class="bottom-background__img"><img src="<?php echo base_url();?>Assest/img/bottom-bg.png" alt="img"></div>
							</div>
						</div>
					</div>
				</section>
