...
<?php
                        $getU_id=$this->session->userdata('user_id'); 
                        $userDetai=getUserDetailsByspon_Id($getU_id);
            ?>
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-info" style="background: #000f15; height: 64px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="<?php echo base_url();?>admin/dashboard" class="nav-link" style="margin-top: 5px;color: #cde1ff;">User Panel</a>
      </li>
    </ul>
      ...
      <li class="nav-item dropdown">
          ...
          <li class="nav-item">
            <a class="nav-link" data-widget="fullscreen" href="#" role="button" >
              <img class="w-full" src="<?php echo base_url();?>public/earth.png" alt="Flag image for en">
            </a>
          </li>
          
        <a class="nav-link" data-toggle="dropdown" href="#" aria-expanded="false">
                <img src="<?php echo base_url();?>public/person.png" class="img-circle elevation-2" style="height: 35px; margin-top: 0px;" alt="User Image">
                    </a>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                        ...
                        <li  class="nav-item">
                            <a href="<?php echo base_url();?>My-Profile" class="nav-link ">
            ...
            <!-- active -->
            <li class="nav-item">
                              <a href="<?php echo base_url();?>Top-Up-User"  class="nav-link nav-normal">
            ...
            <!-- mycontract -->
            <li class="nav-item">
                              <a href="<?php echo base_url();?>my-contract"  class="nav-link nav-normal">
      ...
      <ul class="nav nav-treeview" id="sendRequestSubmenu" style="display: none;">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url();?>Deposite" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Send Request A</p>
          </a>
        </li>
        <!-- Option B under Send Request -->
        <li class="nav-item">
          <a href="<?php echo base_url();?>AnotherSendRequestLink" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Send Request B</p>
          </a>
        </li>
      </ul>
    </li>
      ...
      <ul class="nav nav-treeview" id="requestHistorySubmenu" style="display: none;">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url();?>Deposite-History" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Request History C</p>
          </a>
        </li>
        <!-- Option D under Request History -->
        <li class="nav-item">
          <a href="<?php echo base_url();?>AnotherRequestHistoryLink" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Request History D</p>
          </a>
        </li>
      </ul>
    </li>
    ...
    submenu.style.display = (submenu.style.display === 'none' || submenu.style.display === '') ? 'block' : 'none';
            ...
            <!-- withdraw list menu -->
                        ...
                        <p>
                          ...
                          <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>View-Withdraw-Request-crpto" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Send Request</p>
                            </a>
                          </li>
                          ...
                          <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>View-Withdraw-History-crpto" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Request History</p>
                            </a>
                          </li>
            ...
            <!--            <li  class="nav-item">-->
            <!--                -->
            <!--                <a href="<?php echo base_url();?>View-Withdraw-Request" class="nav-link">-->
            <!--                -->
            <!--                  <i class="fas fa-caret-right-o nav-icon"></i> -->
            <!--                  <p>Send Request</p>-->
            <!--                </a>-->
            ...
            <!--              <li  class="nav-item">-->
            <!--                -->
            <!--                <a href="<?php echo base_url();?>View-Withdraw-History" class="nav-link">-->
            <!--                -->
            <!--                  <i class="fas fa-caret-right-o nav-icon"></i> -->
            <!--                  <p>Request History</p>-->
            <!--                </a>-->
            ...
            <!--              <li  class="nav-item">-->
            <!--                -->
            <!--                <a href="<?php echo base_url();?>Beneficiary" class="nav-link">-->
            <!--                -->
            <!--                  <i class="fas fa-caret-right-o nav-icon"></i> -->
            <!--                  <p>Beneficiary</p>-->
            <!--                </a>-->
            ...
            <!-- withdraw list menu -->
             ...
             <!-- team list menu -->
                        ...
                        <p>
                         ...
                         <!--<li  class="nav-item">-->
                         <!--   -->
                         <!--   <a href="<?php echo base_url();?>Register/admin" target="_blank" class="nav-link">-->
                         <!--   -->
                         <!--     <i class="fas fa-caret-right-o nav-icon"></i> -->
                         ...
                         <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>View-Direct-Active" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Direct Active</p>
                            </a>
                         </li>
                         ...
                         <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>View-Direct-InActive" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                         ...
                         <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>View-Direct-Team" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Direct Team</p>
                            </a>
                         </li>
                         ...
                         <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>Position-Downline" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>All Team</p>
                            </a>
                         </li>
                         ...
                         <!--<li  class="nav-item">-->
                         <!--   -->
                         <!--   <a href="<?php echo base_url();?>Left-Team-Member" class="nav-link">-->
                         <!--   -->
                         <!--     <i class="fas fa-caret-right-o nav-icon"></i> -->
                         ...
                         <!--<li  class="nav-item">-->
                         <!--   -->
                         <!--   <a href="<?php echo base_url();?>Right-Team-Member" class="nav-link">-->
                         <!--   -->
                         <!--     <i class="fas fa-caret-right-o nav-icon"></i> -->
                         ...
                         <!--<li  class="nav-item">-->
                         <!--   -->
                         <!--   <a href="<?php echo base_url();?>Genealogy" class="nav-link">-->
                         <!--   -->
                         <!--     <i class="fas fa-caret-right-o nav-icon"></i> -->
                         <!--     <p>Tree View</p>-->
                         <!--   </a>-->
            ...
            <!-- earning list menu -->
                        ...
                        <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>ROI-History" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Cashback Bonus</p>
                            </a>
                        </li>
                        ...
                        <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>Leadership-Income" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                        ...
                        <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>Bonanza-Reward-Income" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Booster Bonus</p>
                            </a>
                        </li>
            ...
            <!--<li class="nav-item">-->
            <!--  -->
            <!--    <a href="<?php echo base_url();?>Crypto"  class="nav-link">-->
            <!--  -->
            <!--    <i class="nav-icon fab fa-bitcoin"></i>-->
            <!--    <p>-->
            <!--      Crypto-->
            ...
            <!-- my ticket list menu -->
                        ...
                        <p>
                         ...
                         <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>Generate-Ticket" class="nav-link">
                                                          <i class="far fa-circle nav-icon"></i> 
                              <p>Generate Ticket</p>
                            </a>
                          </li>
                           ...
                           <li  class="nav-item">
                                                        <a href="<?php echo base_url();?>Support" class="nav-link">
                                                          <i class="far fa-circle nav-icon"></i> 
                              <p>Support</p>
                            </a>
                          </li>
            ...
            <!-- promotional tool list menu -->
             ...
             <!--logout -->
            <li class="nav-item">
                                <a href="<?php echo base_url();?>Logout"  class="nav-link nav-normal">
