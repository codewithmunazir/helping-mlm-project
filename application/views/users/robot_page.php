                   ...
                   <!-- Main content -->
                    <section class="content">
                      <div class="container-fluid" style="margin-top: -35px;">
                          ...
                          <?php } ?>           </div>
                                        <div class="card-body">
                                            <form role="form"  id="mypassform" action="<?php echo base_url();?>buy-bv" method="POST" >
                                        	
                                        	 <h4 class="text-red mt-5">My Activation Amount 
                                    
                                    <span class="text-primary">$ <?php  echo getfunds($userDetai->user_id);?></span></h4>
                                        	  <!--   <div class="col-md-12 mb-3">
                                                    <label for="sponsed_id"><strong>User ID</strong></label> <span id="alertmsg" class="ml-2"></span></label>
                                            ...
                                            <?php foreach($getpack_robot as $pack){ ?>
                                             
        <option value="<?php echo intval($pack['amt']) ;?>"> $<?php echo $pack['amt']." "; echo " BV "; echo  $pack['bv']; echo "  Valid  Months ".$pack['valid_month'];?></option>
        <?php }?>
                                             ...
                                             <?php echo form_input(['class'=>'form-control','type'=>'password','id'=>'topnewPassword', 'name'=>'tnxpass','placeholder'=>'Enter transaction Password']);?>
                                                ...
                                                <br>
                                                <center>
                                                    <button class="btn btn-primary text-center" id="submit" type="submit">Buy Bot</button>
                                                </center>
                                            </form>
                                        </div>
                                    </div>
