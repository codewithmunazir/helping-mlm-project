                  ...
                  <div class="content-header">
                    <div class="container-fluid">
                      <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                          <div class="float-sm-right text-dark"><p>INCOME<span class="text-primary">/</span>BOT INCOME</p></div>
                    ...
                    <section class="content">
                      <div class="container-fluid" style="margin-top: -35px;">
                            ...
                            <div class="col-12 mt-5">
                             ...
                             <?php foreach($bv_trade_history as $bott)
      {?>

                      <tr>
                   <td></td>
                   <td><?php echo $bott['match_bv'];?></td>
