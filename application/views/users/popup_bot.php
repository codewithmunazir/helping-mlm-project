...
<body class="bg-image">
  <div class="container" id="rredir" baseuiurl="<?php echo base_url();?>buy-bv">
        ...
        <div class="card mt-5" style="background-color:#2f3944;
          ...
          <div class="card-body text-center">
              ...
              <?php
                                         ...
                                         $getdtails=Last_bot_Details_po_up($top_up_id);
                                       //  print_r($getdtails);
                                         $datetime = $getdtails->purchage_date;// Example datetime from database
...
?>
                                               ...
                                               <h3><span style="color:#ff6e40!important;"><b>Congratulation!<b></span></h3>
                                                <h4>Your Have Buy Your Robot Successfully<br><sanp style=" font-size: 25px; /* Adjust font size as needed */    font-weight: bold;    background: -webkit-gradient(linear, left top, right top, color-stop(0%, #ff6c2f), color-stop(25%, #f9b931), color-stop(50%, #22c55e), color-stop(75%, #3b82f6), color-stop(100%, #8b5cf6)); background: linear-gradient(to right, #ff6c2f 0%, #f9b931 25%, #22c55e 50%, #3b82f6 75%, #8b5cf6 100%); background-size: 400% 100%; background-clip: text;  color: transparent;  -webkit-background-clip: text; -webkit-text-fill-color: transparent;   -webkit-animation: textclip 5s linear infinite;  animation: textclip 5s linear infinite; display: inline-block;">EQUITY PLUS
ROBOTS TRADING</sanp></h4>
                                               <h4>BOT ID: <?php echo $usrdetailstts->bot_id;?></h4>
                                               
                                                 <h4><?php echo "Your User ID: ";?> <?php echo $getdtails->registeruser_id;?></h4>
                                                 <img src="<?php echo base_url();?>User_assest/images/img7.png" alt="not found" class="img-fluid" height="80px" width="135px">
    ...
    -webkit-background-clip: text; -webkit-text-fill-color: transparent; -webkit-animation: textclip 5s linear infinite; animation: textclip 5s linear infinite; display: inline-block;"><b> ($ <?php echo $getdtails->amt;?>)</b></span></h4>
                                                        <h4>BV : <?php echo $getdtails->bv;?></h4>
                                                        <h4>Valid Month : <?php echo $getdtails->valid_month;?></h4>
                                                         <!-- <h4>Exipre :<?php // echo $getdtails->expire_date;?></h4> -->
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
   ...
   <script>
        document.addEventListener("click", function() {
         const element = document.getElementById("rredir");
