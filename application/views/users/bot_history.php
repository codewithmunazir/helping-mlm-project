                    ...
                    <section class="content">
                      <div class="container-fluid" style="margin-top: -35px;">
                            ...
                            <div class="col-12 mt-5">
                             ...
                             <?php foreach($bot_history as $bott)
      {?>

                      <tr>
                   <td></td>
                   <td><?php echo $bott['bot_user_id'];?></td>
                   <td>$<?php echo $bott['amt'];?></td>
                   <td><?php echo $bott['bv'];?></td>
                   <td><?php echo $bott['purchage_date'];?></td>
                   <td><?php echo $bott['valid_month'];?></td>
                    <td><a href="#" class="btn btn-danger"><?php echo $bott['expire_date'];?></a></td>
                      </tr>
                      <?php } ?>
