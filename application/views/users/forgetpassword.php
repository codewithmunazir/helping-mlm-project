    ...
    <div class="wrapper">
        <div class="d-flex align-items-center justify-content-center my-5 my-lg-0">
            <div class="container">
                            ...
                            <div class="card-body" style=" margin: auto; padding: 2rem; background: rgb(255 255 255 / 22%); border-radius: 16px; backdrop-filter: blur(7.4px);">
                                <div class=" p-4 rounded">
                                    <div class="text-center">
                                        <h3 class="" style="color: white;">Reset Password</h3>
                                        <p style="color: white;">
                                            Enter your User Id  and we'll send you an email with instructions to reset your password.
                                        </p>
                                        <p style="color: white;">
                                            Back to <a href="<?php echo base_url();?>signin" style="color: #9edbf2">Sign In </a>
                                        </p>
                                    </div>
              ...
              <?php } ?>
                                     <h2 class="fw-bold fs-24"></h2>

                                        <p class="text-muted mt-1 mb-4"></p>

                                        <div>
                                              
                                             <form  class="authentication-form" action="<?php echo base_url();?>forgot-password" method="POST">
                                                  <div class="mb-3">
                                                       <label class="form-label" for="sponsed_id" >User ID  <span id="alertmsg"></span> </label>
                                                       <input class="form-control" placeholder="Enter your User Id" type="text"  placeholder="User id" name="sponsed_id" id="sponsed_id" onchange="return getsponserdId();" required>
                                                  </div>
...
{
  var delurl = "https://doublepower33days.com/Home/pasword_details";
...
// "id":"1","user_id":"Masterbot","sponserd_id":"0","email":"infomaster@email.com","mobile":"0000123212","fullname":"Admin","topupdate":"2024-10-05 13:23:22","topup_amt":"0.00","password":"ajsdbvv323@!#$","isactive":"1","register_date":"2024-10-05 13:23:22","txn_password":"123456","isvalid":"0","topupby":"","pack_id":"0","packnm
//             //
    ...
    const obj = JSON.parse(data);
            $("#alertmsg").html('<span class="text-success">'+obj.fullname+'</span>');
