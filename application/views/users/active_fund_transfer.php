                  ...
                  <div class="content-header">
                   ...
                   <!-- Main content -->
                    <section class="content">
                      ...
                      <?php } ?>  </div>
                                        <div class="card-body">
                                            <form role="form"  id="mypassform" aaction="<?php echo base_url();?>fund_transfer_active" method="POST">
                                        	<h4 class="text-red mt-5">My Activation Amount <span class="text-primary">$ <?php  echo getfunds($userDetai->user_id);?></span></h4>
                                        	    <div class="col-md-12 mb-3">
                                                    <label for="pppassword"><strong>User ID</strong></label> <span id="alertmsg" class="ml-2"></span>
                                            ...
                                            <div class="input-group">
                                              <?php echo form_input(['class'=>'form-control','type'=>'password','id'=>'tnxpass_1', 'name'=>'tnxpass','placeholder'=>'Enter transaction Password']);?>
                                                ...
                                                <br>
                                                <center>
                                                <input class="btn btn-primary text-center" id="submit" type="submit" value="Transfer P2P">
                                                                </center>
                                            </form>
                                        </div>
                                    </div>
