...
<head>
  ...
  <link rel="stylesheet" href="<?PHP echo base_url();?>User_assest/css/all.min.css">
  ...
  <nav class="main-header navbar navbar-expand navbar-dark navbar-info" style="background: #000f15; height: 64px;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <!-- <a href="<?php //echo base_url();?>admin/dashboard" class="nav-link fw-bold footer-texttt" >EQUITY PLUS</a> -->
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <li class="nav-item dropdown">
         ...
         <!--  <li class="nav-item">
          ...
          <a href="<?php echo base_url();?>admin/dashboard" class="nav-link fw-bold footer-texttt" style="float:left; margin-left:0px;" >EQUITY PLUS</a>
...
<aside class="main-sidebar elevation-4 sidebar-light-info" style="background: #000f15; min-height: 1400px;">
    ...
    <p style="    margin-top: -15px; margin-left: 20px; color: #9097a6; font-size: 11px; font-weight: 600;">By EquityPlus</p>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column nav-flat" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
            ...
            <li class="nav-item">
                    ...
                    <li class="nav-item">
                     ...
                     <i class="nav-icon fas fa-coins"></i>
                        ...
                        <ul class="nav nav-treeview" >
                            <li  class="nav-item">
                                <a href="<?php echo base_url();?>funds-request" class="nav-link ">
                                 <i class="fas fa-caret-right-o nav-icon"></i>
                                  <p>Fund Request</p>
                                </a>
                            </li>
                            ...
                            <li  class="nav-item">
                                <a href="<?php echo base_url();?>fund_transfer_active" class="nav-link ">
                                 <i class="fas fa-caret-right-o nav-icon"></i>
                                  <p>Fund Transfer</p>
                                </a>
                            </li>
                            <li  class="nav-item">
                                <a href="<?php echo base_url();?>fund-transfer-recieve-details" class="nav-link ">
                                 <i class="fas fa-caret-right-o nav-icon"></i>
                                  <p>Activation Wallet-History</p>
                                </a>
                            </li>
                ...
                <ul class="nav nav-treeview" >
                        ...
                        <li  class="nav-item">
                          ...
                          <li  class="nav-item">
                            ...
                            <a href="<?php echo base_url();?>binary-tree" class="nav-link ">
                    
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Binary Represent Team</p>
                            </a>
                          </li>
            ...
            <!-- profile list menu -->
                    ...
                    <!-- <li class="nav-item">
                     ...
                     <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" >                        
                        <li  class="nav-item">
                            <a href="<?php echo base_url();?>buy-bv" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Buy BV</p>
                            </a>
                          </li>
                          <li  class="nav-item">
                            <a href="<?php echo base_url();?>bot-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Bot History</p>
                            </a>
                          </li>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview" >
                        <li  class="nav-item">
                            <a href="<?php echo base_url();?>bv-matching-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>BV Matching History</p>
                            </a>
                          </li>
                          <li  class="nav-item">
                            <a href="<?php echo base_url();?>bv-matching-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>BV Royalty club  Matching History</p>
                            </a>
                          </li>                        
                         <!-- bv-trade-history -->
                         <!-- <li  class="nav-item">
                            <a href="<?php //echo base_url();?>bv-trade-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Trade Income History</p>
                            </a>
                          </li>
                           <li  class="nav-item">
                            <a href="<?php //echo base_url();?>bv-trade-income-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Daily Trade Income History</p>
                            </a>
                          </li>
                          <li  class="nav-item">
                            <a href="<?php //echo base_url();?>bv-reward-income-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Reward Income History</p>
                            </a>
                          </li>
                          <li  class="nav-item">
                            <a href="<?php //echo base_url();?>bv-matching-royalty-income-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Royalty Club Income History</p>
                            </a>
                          </li> -->
                      </ul>   
                    </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview" >                        
                         <li  class="nav-item">
                            <a href="<?php echo base_url();?>top-up" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Invest</p>
                            </a>
                          </li>
                           <li  class="nav-item">
                            <a href="<?php echo base_url();?>top-up-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p>Our Investment</p>
                            </a>
                          </li>
  ...
  <ul class="nav nav-treeview">
    <!-- Submenu: Send Request -->
    <li class="nav-item">
      <a href="#" class="nav-link" id="sendRequestLink">
          <i class="fas fa-robot nav-icon"></i>  
        <p>BOT INCOME</p>
      </a>
      <ul class="nav nav-treeview" id="sendRequestSubmenu" style="display: none;">
        <!-- Option A under Send Request -->

        <li  class="nav-item">
                            <a href="<?php echo base_url();?>bv-trade-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p class="text-primary">Trade Income History</p>
                            </a>
                          </li>
                           <li  class="nav-item">
                            <a href="<?php echo base_url();?>bv-trade-income-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p class="text-primary">Daily Trade Income History</p>
                            </a>
                          </li>
                          <li  class="nav-item">
                            <a href="<?php echo base_url();?>bv-reward-income-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p class="text-primary">Reward Income History</p>
                            </a>
                          </li>
                          <li  class="nav-item">
                            <a href="<?php echo base_url();?>bv-matching-royalty-income-history" class="nav-link ">
                             <i class="fas fa-caret-right-o nav-icon"></i>
                              <p class="text-primary">Royalty Club Income History</p>
                            </a>
                          </li>
      </ul>
    </li>

    <!-- Submenu: Request History -->
    <li class="nav-item">
      ...
      <ul class="nav nav-treeview" id="requestHistorySubmenu" style="display: none;">
        ...
        <li class="nav-item">
          <a href="<?php echo base_url();?>daily-trade-bonus" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Daily ROI Income</p>
          </a>
        </li>
        <!-- Option D under Request History -->
        <li class="nav-item">
          <a href="<?php echo base_url();?>direct-bonus" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Direct Income</p>
          </a>
        </li>
         <li class="nav-item">
          <a href="<?php echo base_url();?>plus-level-bonus" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Equity Plus Level Bonus</p>
          </a>
        </li>
        <!-- Option D under Request History -->
        <li class="nav-item">
          <a href="<?php echo base_url();?>level-maintain-bounus" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Level Maintain Income</p>
          </a>
        </li>
         <li class="nav-item">
          <a href="<?php echo base_url();?>fast-track-bonus" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Fast Track Income</p>
          </a>
        </li>
        <!-- Option D under Request History -->
        <li class="nav-item">
          <a href="<?php echo base_url();?>reward-bonus" class="nav-link">
            <i class="fas fa-caret-right-o nav-icon"></i> 
            <p class="text-primary">Reward Income</p>
          </a>
        </li>
      </ul>
    </li>
...
<script>
  document.getElementById('sendRequestLink').addEventListener('click', function() {
    var submenu = document.getElementById('sendRequestSubmenu');
    submenu.style.display = (submenu.style.display === 'none' || submenu.style.display === '') ? 'block' : 'none';
  });

  document.getElementById('requestHistoryLink').addEventListener('click', function() {
    var submenu = document.getElementById('requestHistorySubmenu');
    submenu.style.display = (submenu.style.display === 'none' || submenu.style.display === '') ? 'block' : 'none';
  });
</script>
            <!-- deposite list menu -->
                        ...
                        <li  class="nav-item">
                                                        <a href="<?php // echo base_url();?>Deposite" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Send Request</p>
                            </a>
                          </li>
                          ...
                          <li  class="nav-item">
                                                        <a href="<?php // echo base_url();?>Deposite-History" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Request History</p>
                            </a>
                          </li>
            ...
            <!--              <li  class="nav-item">-->
            <!--                -->
            <!--                <a href="<?php // echo base_url();?>Fund-Convert" class="nav-link">-->
            <!--                -->
            <!--                  <i class="fas fa-caret-right-o nav-icon"></i> -->
            <!--                  <p>Fund Convert</p>-->
            <!--                </a>-->
            ...
            <!--              <li  class="nav-item">-->
            <!--                -->
            <!--                <a href="<?php // echo base_url();?>Fund-Transfer-History" class="nav-link">-->
            <!--                -->
            <!--                  <i class="fas fa-caret-right-o nav-icon"></i> -->
            <!--                  <p>User History</p>-->
            <!--                </a>-->
            <!--              </li>-->
                          ...
                          <!--<li  class="nav-item">-->
                          <!--  -->
                          <!--  <a href="<?php //echo base_url();?>Admin-Fund-Transfer-History" class="nav-link">-->
                          <!--  -->
                          <!--    <i class="fas fa-caret-right-o nav-icon"></i> -->
                          <!--    <p>Admin History</p>-->
                          <!--  </a>-->
            ...
            <!-- withdraw list menu -->
                        ...
                        <p>
                         ...
                         <!--  <li  class="nav-item">
                                                        <a href="<?php //echo base_url();?>Beneficiary-crpto" class="nav-link">
                                                          <i class="fas fa-caret-right-o nav-icon"></i> 
                              <p>Beneficiary</p>
                            </a>
                          </li> -->
            ...
            <li class="nav-item">
            <!--  -->
                <a href="<?php echo base_url();?>compound-system"  class="nav-link">
            <!--  -->
