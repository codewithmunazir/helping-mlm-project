                                             ...
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-truncate">Total Team</p>
                                                            <h3 class="text-dark mt-1 mb-0"><?php echo $team_member;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                        ...
                                        <div class="card overflow-hidden">
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-truncate">Total Team Business</p>
                                                            <h3 class="text-dark mt-1 mb-0">$<?php echo $mybusiness;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                        ...
                                        <div class="card overflow-hidden">
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-danger">Inactive</p>
                                                            <h3 class="text-dark mt-1 mb-0"><?php echo $inactive_no;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                                  <div class="d-flex align-items-center justify-content-between">
                                                       <div>
                                                            <span class="text-danger"> <i class="bx bxs-down-arrow fs-12"></i> 2.3%</span>
                                                            <span class="text-muted ms-1 fs-12">Last Week</span>
                                                       </div>
                                                       <a href="#!" class="text-reset fw-semibold fs-12">View More</a>
                                                  </div>
                                        ...
                                        <div class="card overflow-hidden">
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-success">Active</p>
                                                            <h3 class="text-dark mt-1 mb-0"><?php echo $active_no;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                        ...
                                        <div class="card overflow-hidden">
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-truncate">Left Team</p>
                                                            <h3 class="text-dark mt-1 mb-0"><?php echo $left_team;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                                  <div class="d-flex align-items-center justify-content-between">
                                                       <div>
                                                            ...
                                                            <span class="text-muted ms-1 fs-12">Left Business</span>
                                                       </div>
                                                       <a href="#!" class="text-reset fw-semibold fs-12">View More</a>
                                                  </div>
                                             </div> <!-- end card body -->
                                        ...
                                        <div class="card overflow-hidden">
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-truncate">Left Business </p>
                                                            <h3 class="text-dark mt-1 mb-0">$<?php echo $left_business;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                        ...
                                        <div class="card overflow-hidden">
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-truncate">Right Team</p>
                                                            <h3 class="text-dark mt-1 mb-0"><?php echo $right_team;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                             <div class="card-footer py-2 bg-light bg-opacity-50">
                                                  <div class="d-flex align-items-center justify-content-between">
                                                       <div>
                                                            <span class="text-Success"> <i class="bx bxs-up-arrow fs-12"></i>$</span>
                                                            <span class="text-muted ms-1 fs-12">Right Business</span>
                                                       </div>
                                                       <a href="#!" class="text-reset fw-semibold fs-12">View More</a>
                                                  </div>
                                             </div> <!-- end card body -->
                                        ...
                                        <div class="card overflow-hidden">
                                             <div class="card-body">
                                                  <div class="row">
                                                       ...
                                                       <div class="col-6 text-end">
                                                            <p class="text-muted mb-0 text-truncate">Right Business </p>
                                                            <h3 class="text-dark mt-1 mb-0">$<?php echo $right_business;?></h3>
                                                       </div> <!-- end col -->
                                                  </div> <!-- end row-->
                                             </div> <!-- end card body -->
                                             <div class="card-footer py-2 bg-light bg-opacity-50">
                         ...
                         <div class="col-lg-4">
                              <div class="card">
                                   <div class="card-body">
                                        ...
                                        <div class="row text-center" id="binaryBusiness" data-binarybusiness="<?php echo $binary_bonus;?>">
                                             <div class="col-6">
                                                  <p class="text-muted mb-2">Left Business</p>
                                                  <h3 class="text-dark mb-3">$<?php echo $left_business;?></h3>
                                             </div> <!-- end col -->
                                             <div class="col-6">
                                                  <p class="text-muted mb-2" >Right Busines</p>
                                                  <h3 class="text-dark mb-3">$<?php echo $right_business;?></h3>
                                             </div> <!-- end col -->
                                        </div> <!-- end row -->
                                        ...
                                        <table class="table mb-0">
                                             ...
                                             <tbody>
                                                  <tr>
                                                       ...
                                                       <td>29 April 2024</td>
                                                       <td>
                                                            <img src="<?php echo base_url();?>User_assets/assets/images/products/product-1(1).png" alt="product-1(1)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="<?php echo base_url();?>User_assets/assets/images/products/product-4.png" alt="product-4" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="<?php echo base_url();?>User_assets/assets/images/products/product-5.png" alt="product-5" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>21 April 2024</td>
                                                       <td>
                                                            <img src="<?php echo base_url();?>User_assets/assets/images/products/product-6.png" alt="product-6" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>18 April 2024</td>
                                                       <td>
                                                            <img src="<?php echo base_url();?>User_assets/assets/images/products/product-1(2).png" alt="product-1(2)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
