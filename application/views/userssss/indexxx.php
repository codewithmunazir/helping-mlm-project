...
<head>
     ...
     <!-- App favicon -->
     <link rel="shortcut icon" href="Userf/images/favicon.ico">

     <!-- Vendor css (Require in all Page) -->
     <link href="Userf/css/vendor.min.css" rel="stylesheet" type="text/css" />

     <!-- Icons css (Require in all Page) -->
     <link href="Userf/css/icons.min.css" rel="stylesheet" type="text/css" />

     <!-- App css (Require in all Page) -->
     <link href="Userf/css/app.min.css" rel="stylesheet" type="text/css" />

     <!-- Theme Config js (Require in all Page) -->
     <script src="Userf/js/config.js"></script>
</head>
...
<body>
                                   ...
                                   <div class="dropdown-menu py-0 dropdown-lg dropdown-menu-end" aria-labelledby="page-header-notifications-dropdown">
                                        ...
                                        <div data-simplebar style="max-height: 280px;">
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom text-wrap">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="Userf/images/users/avatar-1.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-1" />
                                                       </div>
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="Userf/images/users/avatar-3.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-3" />
                                                       </div>
                                                       <div class="flex-grow-1">
                                             ...
                                             <a href="javascript:void(0);" class="dropdown-item py-3 border-bottom">
                                                  <div class="d-flex">
                                                       <div class="flex-shrink-0">
                                                            <img src="Userf/images/users/avatar-5.jpg" class="img-fluid me-2 avatar-sm rounded-circle" alt="avatar-5" />
                                                       </div>
                                                       <div class="flex-grow-1">
                              ...
                              <div class="dropdown topbar-item">
                                   <a type="button" class="topbar-button" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        <span class="d-flex align-items-center">
                                             <img class="rounded-circle" width="32" src="Userf/images/users/avatar-1.jpg" alt="avatar-3">
                                        </span>
                                   </a>
                    ...
                    <div class="offcanvas-body p-0">
                         <div data-simplebar class="h-100 p-4">
                              <div class="position-relative ms-2">
                                   ...
                                   <div class="position-relative ps-4">
                                        <div class="mb-4">
                                             <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img src="Userf/images/users/avatar-7.jpg" alt="avatar-5" class="avatar-sm rounded-circle"></span>
                                             <div class="ms-2">
                                                  ...
                                                  <div class="row g-2 mt-2">
                                                       <div class="col-lg-4">
                                                            <a href="#!">
                                                                 <img src="Userf/images/small/img-6.jpg" alt="" class="img-fluid rounded">
                                                            </a>
                                                       </div>
                                                       <div class="col-lg-4">
                                                            <a href="#!">
                                                                 <img src="Userf/images/small/img-3.jpg" alt="" class="img-fluid rounded">
                                                            </a>
                                                       </div>
                                                       <div class="col-lg-4">
                                                            <a href="#!">
                                                                 <img src="Userf/images/small/img-4.jpg" alt="" class="img-fluid rounded">
                                                            </a>
                                                       </div>
                                                  </div>
                                   ...
                                   <div class="position-relative ps-4">
                                        <div class="mb-4">
                                             <span class="position-absolute start-0 translate-middle-x bg-success bg-gradient d-inline-flex align-items-center justify-content-center rounded-circle text-light fs-20"><img src="Userf/images/users/avatar-6.jpg" alt="avatar-5" class="avatar-sm rounded-circle"></span>
                                             <div class="ms-2">
          ...
          <div class="main-nav">
               ...
               <div class="logo-box">
                    <a href="index.html" class="logo-dark">
                         <img src="Userf/images/logo-sm.png" class="logo-sm" alt="logo sm">
                         <img src="Userf/images/logo-dark.png" class="logo-lg" alt="logo dark">
                    </a>

                    <a href="index.html" class="logo-light">
                         <img src="Userf/images/logo-sm.png" class="logo-sm" alt="logo sm">
                         <img src="Userf/images/logo-light.png" class="logo-lg" alt="logo light">
                    </a>
               </div>
                                        ...
                                        <table class="table mb-0">
                                             ...
                                             <tbody>
                                                  <tr>
                                                       ...
                                                       <td>29 April 2024</td>
                                                       <td>
                                                            <img src="Userf/images/products/product-1(1).png" alt="product-1(1)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="Userf/images/products/product-4.png" alt="product-4" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>25 April 2024</td>
                                                       <td>
                                                            <img src="Userf/images/products/product-5.png" alt="product-5" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>21 April 2024</td>
                                                       <td>
                                                            <img src="Userf/images/products/product-6.png" alt="product-6" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
                                                  ...
                                                  <tr>
                                                       ...
                                                       <td>18 April 2024</td>
                                                       <td>
                                                            <img src="Userf/images/products/product-1(2).png" alt="product-1(2)" class="img-fluid avatar-sm">
                                                       </td>
                                                       <td>
     ...
     <script src="Userf/js/vendor.js"></script>

     <!-- App Javascript (Require in all Page) -->
     <script src="Userf/js/app.js"></script>

     <!-- Vector Map Js -->
     <script src="Userf/vendor/jsvectormap/js/jsvectormap.min.js"></script>
     <script src="Userf/vendor/jsvectormap/maps/world-merc.js"></script>
     <script src="Userf/vendor/jsvectormap/maps/world.js"></script>

     <!-- Dashboard Js -->
     <script src="Userf/js/pages/dashboard.js"></script>
